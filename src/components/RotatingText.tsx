      ...
      >
        ...
        <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
          <motion.span
            ...
            className={cn('rotating-text__wrapper', splitBy === 'lines' ? 'rotating-text__lines' : undefined)}
            layout
            aria-hidden="true"
          >
            {elements.map((wordObj, wordIndex, array) => {
              ...
              return (
                <span key={wordIndex} className={cn('rotating-text__split', splitLevelClassName)}>
                  {wordObj.characters.map((char, charIndex) => (
                    <motion.span
                      ...
                      className={cn('rotating-text__element', elementLevelClassName)}
                    >
                      {char}
                    </motion.span>
                  ))}
                  {wordObj.needsSpace && <span className="rotating-text__space" aria-hidden="true"> </span>}
                </span>
              );
            })}
          </motion.span>
